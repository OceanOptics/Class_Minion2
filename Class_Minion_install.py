...
os.system('sudo cp -r /home/pi/Class_Minion/source/drivers/ms5837-python/ms5837 /home/pi/Class_Minion_scripts/')
os.system('sudo cp -r /home/pi/Class_Minion/source/drivers/tsys01-python/tsys01 /home/pi/Class_Minion_scripts/')
# Exit
os.chdir(ini_dir)
...
os.system("sudo sed -i '/# Print the IP/isudo python /home/pi/Class_Minion_scripts/Class_Minion_finish_install.py\n\n' /etc/rc.local")
